...
# Protein workflow
PROTWORK = "{'stepType': 'Minimization', 'MaxCycles': 500, 'SdCycles': 250, 'IntCutoff': 8.0,'Restraint': False, 'CustomIn': None, 'stepType': 'Minimization'}\n" \
           "{'stepType': 'Heating', 'MDSteps': 10000, 'TimeStep': 0.002, 'Traj': 1000, 'InTemp': 0, 'FiTemp': 300, 'Thermostat': 'Langevin', 'CollisFreq': 2.0, 'Restraint': True, 'RestrAtoms': 'Backbone', 'CustomIn': None, 'stepType': 'Heating'}\n" \
           "{'stepType': 'Simulation', 'MDSteps': 10000, 'TimeStep': 0.002, 'TrajStep': 1000, 'EnsemType': 'NPT', 'Thermostat': 'Langevin', 'CollisFreq': 2.0, 'Restraint': False, 'CoupConst': 2.0, 'FricConst': 2.0, 'Pressure': 1.0, 'Barostat': 'Monte Carlo', 'PressureScaling': 'isotropic', 'Restraint': True, 'RestrAtoms': 'Backbone', 'RestrForce': 0.0, 'CustomIn': None, 'stepType': 'Simulation'}\n" \
           "{'stepType': 'Simulation', 'MDSteps': 1000000, 'TimeStep': 0.002, 'TrajStep': 10000, 'EnsemType': 'NPT', 'Thermostat': 'Langevin', 'CollisFreq': 2.0, 'Restraint': False, 'CoupConst': 2.0, 'FricConst': 2.0, 'Pressure': 1.0, 'Barostat': 'Monte Carlo', 'PressureScaling': 'isotropic', 'Restraint': False, 'RestrForce': 0.0, 'CustomIn': None, 'stepType': 'Simulation'}\n"

# Protein + Ligand workflow
PROTLIGWORK = "{'stepType': 'Minimization', 'MaxCycles': 500, 'SdCycles': 250, 'IntCutoff': 8.0,'Restraint': False, 'CustomIn': None, 'stepType': 'Minimization'}\n" \
              "{'stepType': 'Heating', 'MDSteps': 10000, 'TimeStep': 0.002, 'Traj': 1000, 'InTemp': 0, 'FiTemp': 300, 'Thermostat': 'Langevin', 'CollisFreq': 2.0, 'Restraint': True, 'RestrAtoms': 'Ligand+Backbone', 'CustomIn': None, 'stepType': 'Heating'}\n" \
              "{'stepType': 'Simulation', 'MDSteps': 10000, 'TimeStep': 0.002, 'TrajStep': 1000, 'EnsemType': 'NPT', 'Thermostat': 'Langevin', 'CollisFreq': 2.0, 'Restraint': False, 'CoupConst': 2.0, 'FricConst': 2.0, 'Pressure': 1.0, 'Barostat': 'Monte Carlo', 'PressureScaling': 'isotropic', 'Restraint': True, 'RestrAtoms': 'Ligand+Backbone', 'RestrForce': 0.0, 'CustomIn': None, 'stepType': 'Simulation'}\n" \
              "{'stepType': 'Simulation', 'MDSteps': 1000000, 'TimeStep': 0.002, 'TrajStep': 10000, 'EnsemType': 'NPT', 'Thermostat': 'Langevin', 'CollisFreq': 2.0, 'Restraint': False, 'CoupConst': 2.0, 'FricConst': 2.0, 'Pressure': 1.0, 'Barostat': 'Monte Carlo', 'PressureScaling': 'isotropic', 'Restraint': False, 'RestrAtoms': 'Protein', 'RestrForce': 0.0, 'CustomIn': None, 'stepType': 'Simulation'}\n"
